...
namespace DOS_Generator.Data
{
    public class UnitOfWork : IUnitOfWork
    {
        ...
        public IPortRepository Ports =>
            _portRepository = _portRepository ?? new PortRepository(_context);

        public IAgencyRepository Agencies =>
            _agencyRepository = _agencyRepository ?? new AgencyRepository(_context);

        public IDeclarationRepository Declarations =>
            _declarationRepository = _declarationRepository ?? new DeclarationRepository(_context);

        public IFacilityRepository Facilities =>
            _facilityRepository = _facilityRepository ?? new FacilityRepository(_context);

        public IOfficerRepository Officers =>
            _officerRepository = _officerRepository ?? new OfficerRepository(_context);

        public IShipRepository Ships =>
            _shipRepository = _shipRepository ?? new ShipRepository(_context);
